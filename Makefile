# This Makefile is for the Maypole::Authentication::Abstract extension to perl.
#
...
FULLEXT = Maypole/Authentication/Abstract
BASEEXT = Abstract
PARENT_NAME = Maypole::Authentication
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Maypole/Authentication
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Maypole/Authentication
...
PM_TO_BLIB = Abstract.pm \
	$(INST_LIB)/Maypole/Authentication/Abstract.pm
...
DISTVNAME = Maypole-Authentication-Abstract-0.4
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Abstract.pm $(INST_MAN3DIR)/Maypole::Authentication::Abstract.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Authentication/Abstract.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'version:      0.4' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Abstract.pm $(INST_LIB)/Maypole/Authentication/Abstract.pm 
	$(NOECHO) $(TOUCH) $@
